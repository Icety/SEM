...
public class GameTest {
    ...
    public void testSetScore() throws Exception {
        ...
        assertEquals(100, testGame.score);
    }
...
//    }
    ...
    /**
     * Test whether getProjectiles returns the correct ArrayList of projectiles.
     *
     * @throws Exception
     */
    @Test
    public void testGetProjectiles() throws Exception {
        testGame.tProjectiles = new ArrayList<>();

        assertEquals(new ArrayList<>(), testGame.getProjectiles());
    }

    /**
     * Test whether addProjectiles() works correctly.
     *
     * @throws Exception
     */
    @Test
    public void testAddProjectile() throws Exception {
        ...
        testGame.addProjectile(testProjectile);
        list.add(testProjectile);

        assertEquals(list, testGame.getProjectiles());
    }
